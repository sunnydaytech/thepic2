...
var option =  { projectId: "nich01as-com", keyFilename: './lib/config/gcloud_client_secret.json'};
...
module.exports.set_ = KEY_STORE.set.bind(KEY_STORE);
module.exports.get_ = KEY_STORE.get.bind(KEY_STORE);
module.exports.delete_ = KEY_STORE.delete.bind(KEY_STORE);
